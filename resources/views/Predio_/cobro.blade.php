            ...
            @forelse ($rfacturas as $item)
                <x-table.row wire:loading.class.delaylongest="opacity-50" wire:key="row-{{ $item[0]['id'] }}">
                    ...
                    <x-table.cell>
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['impuesto'] }}</span>
                    </x-table.cell>
                    <x-table.cell style="text-align: right;">
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['actualizacion'] }}</span>
                    </x-table.cell>
                    <x-table.cell style="text-align: right;">
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['recargos'] }}</span>
                    </x-table.cell>
                    <x-table.cell style="text-align: right;">
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['multas'] }}</span>
                    </x-table.cell>
                    <x-table.cell style="text-align: right;">
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['requerimientos'] }}</span>
                    </x-table.cell>
                    <x-table.cell style="text-align: right;">
                        ...
                        <span class="whitespace-nowrap">$ {{ $item[0]['subtotal'] }}</span>
                    </x-table.cell>
...
@livewire('predio.cobrar', ['totalapagar' => $totalapagar,'cuentacorriente' => $cuentacorriente,'rezago' =>$rfacturas,'tipocuota'=>$tipocuota,'predio'=>$predio,'ds'=>$descuentos])
