<div x-data="{openRoles:true, openDistritos:true, openValores:true, openPredios:true}" class="mb-5">
    ...
    <p class="uppercase text-base mb-2 border-b border-rojo rounded-lg px-1.5 w-full">Cobros</p>
    ...
    @can('Cobro Predial')
        ...
        <div class="flex items-center w-full justify-between hover:text-red-600 transition ease-in-out duration-500 hover:bg-gray-100 rounded-xl">
            ...
            <a href="{{ route('cobro_predial') }}" class="capitalize font-medium text-sm flex items-center w-full py-2 px-4 focus:outline-rojo focus:outline-offset-2 rounded-lg">
