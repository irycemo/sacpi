...
<body>
    ...
    <main>
        ...
        <div class="informacion" style="margin-top: 20px;">
            ...
            <p class="parrafo">
                con fundamento en los artículos 1, 2, 3, 4, 17 y 18 de la ley de hacienda municipal y, 1, 3, 7, 10, 12, 24, 30, 36, 38, 54, 55, 63, 64, 69, 113, 114,
                116, 112, 128, 130, 131 y 132; del código fiscal municipal del estado de michoacán, se le requiere para que dentro de los seis dias siguientes a la fecha en que
                se reciba la presente notificación, acuda a la oficina de la tesoreria, a cubrir el impuesto predial de que es usted sujeto ya que de no cumplir esta obligación a
                su cargo, se procederá al embargo de bienes que garanticen el pago del citado credito fiscal, mediante el procedimiento administrativo de ejecución.
            </p>
